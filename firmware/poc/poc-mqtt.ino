...
const char *broker = "3bde4a57fee14109aa72d3b805d645c5.s1.eu.hivemq.cloud";
const uint16_t broker_port = 8883;
const char *broker_username = "avivais";
const char *broker_password = "Avivr_121";
const char *client_id = "A7670G-Avi";
